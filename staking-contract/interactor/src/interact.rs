...
pub async fn staking_contract_cli() {
    ...
    match cmd.as_str() {
        ...
        "getStakedAddresses" => interact.staked_addresses().await,
        "getStakingPosition" => interact.staking_position().await,
...
impl ContractInteract {
    ...
    pub async fn unstake(&mut self) {
        let opt_unstake_amount = OptionalValue::Some(BigUint::<StaticApi>::from(0u128));
    ...
    pub async fn staked_addresses(&mut self) {
    ...
    pub async fn staking_position(&mut self) {
        let addr = bech32::decode("");
